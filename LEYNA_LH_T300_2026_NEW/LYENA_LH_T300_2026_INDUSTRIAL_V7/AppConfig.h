...
static constexpr uint16_t kConfigSchemaVersion = 12;
...
struct AppConfigData {
  ...
  int16_t sensorAnalogMinVoltageX100[kChannelCount];
  int16_t sensorAnalogMaxVoltageX100[kChannelCount];
  int16_t sensorAnalogMinValueX10[kChannelCount];
  int16_t sensorAnalogMaxValueX10[kChannelCount];
