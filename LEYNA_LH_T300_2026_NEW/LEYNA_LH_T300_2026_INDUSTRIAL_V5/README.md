...
- `LEYNA_LH_T300_2026_INDUSTRIAL_V5.ino`: arranque y loop principal.
- `IndustrialApp.*`: scheduler, sensores, control, telemetria, conectividad, OTA y persistencia.
...
- Telemetria JSON, formulario legado y bridge cloud Maintelligence.
...
- `AutoConnect` (dependencia de compilacion transitiva de EdgeUnified, aunque V5 ya no lo usa como portal)
- `ArduinoJson`
- `modbus-esp8266`
- `DallasTemperature`
- `OneWire`
...
- Soak test de WiFi, captive portal, OTA, Modbus y telemetria.
