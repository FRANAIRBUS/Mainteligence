...
exports.workOrders_addReport = exports.workOrders_close = exports.workOrders_start = exports.workOrders_generateNow = exports.generatePreventiveNow = exports.deletePreventiveTemplate = exports.duplicatePreventiveTemplate = exports.updatePreventiveTemplate = exports.createPreventiveTemplate = exports.createPreventive = exports.createAsset = exports.deleteTask = exports.updateTaskStatus = exports.createTask = exports.updateTicketStatus = exports.createTicket = exports.registerTicketAttachment = exports.createTicketUploadSession = exports.createDepartment = exports.createSite = exports.setActiveOrganization = exports.finalizeOrganizationSignup = exports.bootstrapSignup = exports.bootstrapFromInvites = exports.checkOrganizationAvailability = exports.resolveOrganizationId = exports.rootPurgeOrganizationCollection = exports.rootDeleteOrganizationScaffold = exports.orgSetOrganizationStatus = exports.rootSetOrganizationPlan = exports.rootDeactivateOrganization = exports.rootUpsertUserToOrganization = exports.rootListUsersByOrg = exports.rootOrgSummary = exports.rootListOrganizations = exports.rootCreateAccountFromBetaRequest = exports.rootUpdateBetaRequest = exports.rootListBetaRequests = exports.rootSetPublicAppConfig = exports.onTaskDeleted = exports.onTicketDeleted = exports.onTicketClosed = exports.onTaskCreate = exports.onTicketCreate = exports.onTaskAssign = exports.onTicketAssign = exports.submitBetaRequest = exports.gateLoginAccess = exports.checkSignupAllowed = exports.getPublicAppConfig = void 0;
exports.stripeWebhook = exports.appleAppStoreNotifications = exports.registerAppleAppAccountToken = exports.registerGooglePlayPurchase = exports.demoteToAdminWithinOrg = exports.promoteToSuperAdminWithinOrg = exports.setRoleWithinOrg = exports.orgRejectJoinRequest = exports.orgApproveJoinRequest = exports.orgUpdateUserProfileCallable = exports.orgUpdateUserProfile = exports.orgInviteUser = exports.generatePreventiveTickets = exports.pausePreventivesWithoutEntitlement = exports.pauseExpiredDemoPreventives = exports.inviteUserToOrg = void 0;
...
const SCOPED_HEAD_ROLES = new Set(['jefe_departamento', 'jefe_ubicacion', 'operario']);
const MASTER_DATA_ROLES = new Set([...ADMIN_LIKE_ROLES, ...SCOPED_HEAD_ROLES]);
const TASKS_ROLES = new Set([...ADMIN_LIKE_ROLES, ...SCOPED_HEAD_ROLES]);
const USAGE_FIELDS = {
    sites: 'sitesCount',
    assets: 'assetsCount',
...
function resolveEntitlementPlanId({ metadataPlanId, fallbackPlanId, }) {
    const resolvePlanAlias = (planId) => {
        if (planId.startsWith('free'))
            return 'free';
        if (planId.startsWith('basic'))
            return 'basic';
        if (planId.startsWith('standard'))
            return 'starter';
    ...
    const normalized = String(metadataPlanId !== null && metadataPlanId !== void 0 ? metadataPlanId : '').trim().toLowerCase();
    ...
    if (alias)
        return alias;
    const fallbackNormalized = String(fallbackPlanId !== null && fallbackPlanId !== void 0 ? fallbackPlanId : '').trim().toLowerCase();
    if (fallbackNormalized === 'free' ||
...
function hasPlanChanged(currentPlanId, nextPlanId) {
    if (!currentPlanId)
        return true;
...
async function updateOrganizationStripeEntitlement({ orgId, planId, status, trialEndsAt, currentPeriodEnd, }) {
    ...
    await db.runTransaction(async (tx) => {
        ...
        const limits = resolveEffectiveLimitsForPlan(resolvedPlanId, hasPlanChanged(entitlement === null || entitlement === void 0 ? void 0 : entitlement.planId, resolvedPlanId) ? null : entitlement === null || entitlement === void 0 ? void 0 : entitlement.limits);
...
async function requireActiveMembershipForTx(tx, orgId, actorUid) {
    var _a;
    const membershipRef = db.collection('memberships').doc(`${actorUid}_${orgId}`);
    const userRef = db.collection('users').doc(actorUid);
...
async function resolvePlanLimitsForTx(tx, planId, rawLimits) {
    var _a;
    const resolvedPlanId = resolveEntitlementPlanId({ metadataPlanId: planId !== null && planId !== void 0 ? planId : null });
    const planSnap = await tx.get(db.collection('planCatalog').doc(resolvedPlanId));
    const planLimits = planSnap.exists
        ? planSnap.get('limits')
        : undefined;
    return resolveEffectiveLimitsForPlan(resolvedPlanId, (_a = planLimits !== null && planLimits !== void 0 ? planLimits : rawLimits) !== null && _a !== void 0 ? _a : null);
}
...
function resolveEffectiveEntitlementForTx(orgSnap) {
    var _a, _b;
    const orgData = orgSnap.data();
    const entitlement = orgData === null || orgData === void 0 ? void 0 : orgData.entitlement;
    if (!entitlement) {
    ...
    const resolvedPlanId = resolveEntitlementPlanId({
        metadataPlanId: (_a = entitlement.planId) !== null && _a !== void 0 ? _a : null,
        fallbackPlanId: entitlement.planId,
    });
    return Object.assign(Object.assign({}, entitlement), { planId: resolvedPlanId, limits: resolveEffectiveLimitsForPlan(resolvedPlanId, entitlement.limits), usage: (_b = entitlement.usage) !== null && _b !== void 0 ? _b : DEFAULT_ENTITLEMENT_USAGE });
}
...
async function readPublicConfig() {
    ...
    const betaClosed = Boolean(snap.exists ? ((_a = snap.get('betaClosed')) !== null && _a !== void 0 ? _a : false) : false);
...
function requireNonEmptyString(input, field) {
    const v = String(input !== null && input !== void 0 ? input : '').trim();
    if (!v)
        throw httpsError('invalid-argument', `${field} requerido.`);
    return v;
}
...
async function consumeBetaRateLimit(ipHash) {
    ...
    return db.runTransaction(async (tx) => {
        ...
        tx.set(ref, {
            ...
            windowStartMs,
            windowEndsAtMs,
            createdAt: snap.exists ? (_b = snap.get('createdAt')) !== null && _b !== void 0 ? _b : now : now,
            updatedAt: now,
        }, { merge: true });
        return { allowed: true };
    });
...
async function hasPendingInviteForEmailOrUid(opts) {
    var _a, _b;
    const email = ((_a = opts.email) !== null && _a !== void 0 ? _a : '').trim().toLowerCase();
    const uid = ((_b = opts.uid) !== null && _b !== void 0 ? _b : '').trim();
    const queries = [];
    if (email) {
        queries.push(db
...
async function hasAcceptedBetaRequest(email) {
    const snap = await db
...
exports.checkSignupAllowed = functions.https.onCall(async (data, context) => {
    var _a, _b;
    const { betaClosed } = await readPublicConfig();
    if (!betaClosed)
        return { ok: true, allowed: true };
    const email = normalizeEmail(data === null || data === void 0 ? void 0 : data.email);
    const uid = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid) !== null && _b !== void 0 ? _b : null;
    ...
    if (uid) {
        ...
        if (!membershipsSnap.empty)
            return { ok: true, allowed: true, reason: 'has_membership' };
        const authUser = await admin.auth().getUser(uid).catch(() => null);
        const authEmail = normalizeEmail(authUser === null || authUser === void 0 ? void 0 : authUser.email);
        const hasInvite = await hasPendingInviteForEmailOrUid({ email: authEmail, uid });
        if (hasInvite)
            return { ok: true, allowed: true, reason: 'has_invite' };
...
exports.gateLoginAccess = functions.https.onCall(async (_data, context) => {
    const uid = requireAuth(context);
    if (isRootClaim(context))
        return { ok: true, allowed: true, reason: 'root' };
    const { betaClosed } = await readPublicConfig();
    if (!betaClosed)
        return { ok: true, allowed: true, reason: 'open' };
    const membershipsSnap = await db
        .collection('memberships')
        .where('userId', '==', uid)
        .limit(1)
    ...
    if (!membershipsSnap.empty)
        return { ok: true, allowed: true, reason: 'has_membership' };
    const authUser = await admin.auth().getUser(uid).catch(() => null);
    const email = normalizeEmail(authUser === null || authUser === void 0 ? void 0 : authUser.email);
    const hasInvite = await hasPendingInviteForEmailOrUid({ email, uid });
    if (hasInvite)
        return { ok: true, allowed: true, reason: 'has_invite' };
    if (email && (await hasAcceptedBetaRequest(email)))
        return { ok: true, allowed: true, reason: 'beta_accepted' };
    return { ok: true, allowed: false, reason: 'beta_closed' };
});
// Public (unauth) beta request submission.
exports.submitBetaRequest = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u;
    const fullName = requireNonEmptyString(data === null || data === void 0 ? void 0 : data.fullName, 'fullName');
    const companyName = requireNonEmptyString(data === null || data === void 0 ? void 0 : data.companyName, 'companyName');
    const email = normalizeEmail(data === null || data === void 0 ? void 0 : data.email);
    if (!email)
    ...
    const ua = ((_g = (_f = (_e = context.rawRequest) === null || _e === void 0 ? void 0 : _e.headers) === null || _f === void 0 ? void 0 : _f['user-agent']) !== null && _g !== void 0 ? _g : '').toString();
    ...
    const existingStatus = String((_h = existingData === null || existingData === void 0 ? void 0 : existingData.status) !== null && _h !== void 0 ? _h : 'new');
    ...
    const payload = {
        ...
        fullName,
        companyName,
        role: maybeString(data === null || data === void 0 ? void 0 : data.role),
        email,
        phone: maybeString(data === null || data === void 0 ? void 0 : data.phone),
        sector: maybeString(data === null || data === void 0 ? void 0 : data.sector),
        sitesCount: Number.isFinite(Number(data === null || data === void 0 ? void 0 : data.sitesCount)) ? Number(data === null || data === void 0 ? void 0 : data.sitesCount) : null,
        currentTools: maybeString(data === null || data === void 0 ? void 0 : data.currentTools),
        mainPain: maybeString(data === null || data === void 0 ? void 0 : data.mainPain),
        canUseReal2to4Weeks: Boolean((_j = data === null || data === void 0 ? void 0 : data.canUseReal2to4Weeks) !== null && _j !== void 0 ? _j : false),
        wantsDemo: Boolean((_k = data === null || data === void 0 ? void 0 : data.wantsDemo) !== null && _k !== void 0 ? _k : false),
        reviewedBy: (_l = existingData === null || existingData === void 0 ? void 0 : existingData.reviewedBy) !== null && _l !== void 0 ? _l : null,
        reviewedAt: (_m = existingData === null || existingData === void 0 ? void 0 : existingData.reviewedAt) !== null && _m !== void 0 ? _m : null,
        notes: (_o = existingData === null || existingData === void 0 ? void 0 : existingData.notes) !== null && _o !== void 0 ? _o : null,
        createdAccount: Boolean((_p = existingData === null || existingData === void 0 ? void 0 : existingData.createdAccount) !== null && _p !== void 0 ? _p : false),
        createdOrgId: (_q = existingData === null || existingData === void 0 ? void 0 : existingData.createdOrgId) !== null && _q !== void 0 ? _q : null,
        createdUserId: (_r = existingData === null || existingData === void 0 ? void 0 : existingData.createdUserId) !== null && _r !== void 0 ? _r : null,
        createdAt: (_s = existingData === null || existingData === void 0 ? void 0 : existingData.createdAt) !== null && _s !== void 0 ? _s : now,
        updatedAt: now,
        meta: {
            ipHash,
            userAgent: ua || null,
            authUid: (_u = (_t = context.auth) === null || _t === void 0 ? void 0 : _t.uid) !== null && _u !== void 0 ? _u : null,
        },
...
exports.onTicketAssign = functions.firestore
    ...
    if (!before || !after)
        return;
    const beforeAssignedTo = (_a = before.assignedTo) !== null && _a !== void 0 ? _a : null;
    const afterAssignedTo = (_b = after.assignedTo) !== null && _b !== void 0 ? _b : null;
    if (!afterAssignedTo || beforeAssignedTo === afterAssignedTo)
        return;
    try {
        const orgId = (_d = (_c = after.organizationId) !== null && _c !== void 0 ? _c : context.params.orgId) !== null && _d !== void 0 ? _d : null;
        ...
        await (0, assignment_email_1.sendAssignmentEmail)({
            ...
            assignedTo: (_e = after.assignedTo) !== null && _e !== void 0 ? _e : null,
            departmentId: (_f = after.departmentId) !== null && _f !== void 0 ? _f : null,
            title: (_g = after.title) !== null && _g !== void 0 ? _g : '(sin título)',
            link,
            type: 'incidencia',
            identifier: (_h = after.displayId) !== null && _h !== void 0 ? _h : context.params.ticketId,
            description: (_j = after.description) !== null && _j !== void 0 ? _j : '',
            priority: (_k = after.priority) !== null && _k !== void 0 ? _k : '',
            status: (_l = after.status) !== null && _l !== void 0 ? _l : '',
            location: (_m = after.departmentId) !== null && _m !== void 0 ? _m : null,
        });
    }
    catch (error) {
...
exports.onTaskAssign = functions.firestore
    ...
    try {
        ...
        await (0, assignment_email_1.sendAssignmentEmail)({
            organizationId: orgId,
            assignedTo: (_e = after.assignedTo) !== null && _e !== void 0 ? _e : null,
            departmentId: (_f = after.location) !== null && _f !== void 0 ? _f : null,
            title: (_g = after.title) !== null && _g !== void 0 ? _g : '(sin título)',
            link,
            type: 'tarea',
            identifier: context.params.taskId,
            description: (_h = after.description) !== null && _h !== void 0 ? _h : '',
            priority: (_j = after.priority) !== null && _j !== void 0 ? _j : '',
            status: (_k = after.status) !== null && _k !== void 0 ? _k : '',
            dueDate: (_l = after.dueDate) !== null && _l !== void 0 ? _l : null,
            location: (_m = after.location) !== null && _m !== void 0 ? _m : null,
            category: (_o = after.category) !== null && _o !== void 0 ? _o : null,
        });
    }
    catch (error) {
...
exports.rootSetPublicAppConfig = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d;
    const actorUid = requireRoot(context);
    const betaClosed = Boolean((_a = data === null || data === void 0 ? void 0 : data.betaClosed) !== null && _a !== void 0 ? _a : false);
    const now = admin.firestore.FieldValue.serverTimestamp();
    await db
...
exports.rootListBetaRequests = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g;
    requireRoot(context);
    const limit = Math.min(Number((_a = data === null || data === void 0 ? void 0 : data.limit) !== null && _a !== void 0 ? _a : 50), 200);
    const cursorCreatedAtMs = Number((_b = data === null || data === void 0 ? void 0 : data.cursorCreatedAtMs) !== null && _b !== void 0 ? _b : 0);
    const cursorId = String((_c = data === null || data === void 0 ? void 0 : data.cursorId) !== null && _c !== void 0 ? _c : '').trim();
    let query = db
        .collection(BETA_REQUESTS_COLLECTION)
    ...
    const rows = sliced.map((d) => {
        ...
        const v = d.data();
        const createdAt = v === null || v === void 0 ? void 0 : v.createdAt;
        const updatedAt = v === null || v === void 0 ? void 0 : v.updatedAt;
        const reviewedAt = v === null || v === void 0 ? void 0 : v.reviewedAt;
        const toMs = (t) => ((t === null || t === void 0 ? void 0 : t.toMillis) ? t.toMillis() : null);
        return {
            id: d.id,
            status: (_a = v === null || v === void 0 ? void 0 : v.status) !== null && _a !== void 0 ? _a : 'new',
            fullName: (_b = v === null || v === void 0 ? void 0 : v.fullName) !== null && _b !== void 0 ? _b : null,
            companyName: (_c = v === null || v === void 0 ? void 0 : v.companyName) !== null && _c !== void 0 ? _c : null,
            role: (_d = v === null || v === void 0 ? void 0 : v.role) !== null && _d !== void 0 ? _d : null,
            email: (_e = v === null || v === void 0 ? void 0 : v.email) !== null && _e !== void 0 ? _e : null,
            phone: (_f = v === null || v === void 0 ? void 0 : v.phone) !== null && _f !== void 0 ? _f : null,
            sector: (_g = v === null || v === void 0 ? void 0 : v.sector) !== null && _g !== void 0 ? _g : null,
            sitesCount: (_h = v === null || v === void 0 ? void 0 : v.sitesCount) !== null && _h !== void 0 ? _h : null,
            currentTools: (_j = v === null || v === void 0 ? void 0 : v.currentTools) !== null && _j !== void 0 ? _j : null,
            mainPain: (_k = v === null || v === void 0 ? void 0 : v.mainPain) !== null && _k !== void 0 ? _k : null,
            canUseReal2to4Weeks: Boolean((_l = v === null || v === void 0 ? void 0 : v.canUseReal2to4Weeks) !== null && _l !== void 0 ? _l : false),
            wantsDemo: Boolean((_m = v === null || v === void 0 ? void 0 : v.wantsDemo) !== null && _m !== void 0 ? _m : false),
            reviewedBy: (_o = v === null || v === void 0 ? void 0 : v.reviewedBy) !== null && _o !== void 0 ? _o : null,
            reviewedAtMs: toMs(reviewedAt),
            notes: (_p = v === null || v === void 0 ? void 0 : v.notes) !== null && _p !== void 0 ? _p : null,
            createdAccount: Boolean((_q = v === null || v === void 0 ? void 0 : v.createdAccount) !== null && _q !== void 0 ? _q : false),
            createdOrgId: (_r = v === null || v === void 0 ? void 0 : v.createdOrgId) !== null && _r !== void 0 ? _r : null,
            createdUserId: (_s = v === null || v === void 0 ? void 0 : v.createdUserId) !== null && _s !== void 0 ? _s : null,
            createdAtMs: toMs(createdAt),
            updatedAtMs: toMs(updatedAt),
        };
    });
    const nextCursor = hasMore ? docs[limit] : null;
    const nextCursorCreatedAtMs = (_f = (_e = (_d = nextCursor === null || nextCursor === void 0 ? void 0 : nextCursor.get('createdAt')) === null || _d === void 0 ? void 0 : _d.toMillis) === null || _e === void 0 ? void 0 : _e.call(_d)) !== null && _f !== void 0 ? _f : null;
    const nextCursorId = (_g = nextCursor === null || nextCursor === void 0 ? void 0 : nextCursor.id) !== null && _g !== void 0 ? _g : null;
    return {
        ok: true,
        requests: rows,
...
exports.rootUpdateBetaRequest = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d;
    const actorUid = requireRoot(context);
    const requestId = requireNonEmptyString(data === null || data === void 0 ? void 0 : data.requestId, 'requestId');
    const status = String((_a = data === null || data === void 0 ? void 0 : data.status) !== null && _a !== void 0 ? _a : '').trim();
    const notes = maybeString(data === null || data === void 0 ? void 0 : data.notes);
    ...
    const snap = await ref.get();
    if (!snap.exists)
        throw httpsError('not-found', 'Solicitud no encontrada.');
    const now = admin.firestore.FieldValue.serverTimestamp();
    await ref.set({
        status,
        notes,
...
exports.rootCreateAccountFromBetaRequest = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    const actorUid = requireRoot(context);
    ...
    const requestId = requireNonEmptyString(data === null || data === void 0 ? void 0 : data.requestId, 'requestId');
    const roleIn = String((_d = data === null || data === void 0 ? void 0 : data.role) !== null && _d !== void 0 ? _d : 'admin').trim();
    const requestedRole = normalizeRole(roleIn);
    const sendInvite = (data === null || data === void 0 ? void 0 : data.sendInvite) !== false;
    const reqRef = db.collection(BETA_REQUESTS_COLLECTION).doc(requestId);
    const reqSnap = await reqRef.get();
    if (!reqSnap.exists)
        throw httpsError('not-found', 'Solicitud no encontrada.');
    const req = reqSnap.data();
    const email = normalizeEmail(req === null || req === void 0 ? void 0 : req.email);
    if (!email)
        throw httpsError('failed-precondition', 'La solicitud no tiene email.');
    const status = String((_e = req === null || req === void 0 ? void 0 : req.status) !== null && _e !== void 0 ? _e : 'new');
    if (status === 'rejected')
        throw httpsError('failed-precondition', 'Solicitud rechazada.');
    if (Boolean((_f = req === null || req === void 0 ? void 0 : req.createdAccount) !== null && _f !== void 0 ? _f : false)) {
        throw httpsError('failed-precondition', 'Esta solicitud ya fue usada para crear una cuenta.');
    }
    const companyName = String((_g = req === null || req === void 0 ? void 0 : req.companyName) !== null && _g !== void 0 ? _g : '').trim();
    const fullName = String((_h = req === null || req === void 0 ? void 0 : req.fullName) !== null && _h !== void 0 ? _h : '').trim();
    const orgIdInput = String((_j = data === null || data === void 0 ? void 0 : data.organizationId) !== null && _j !== void 0 ? _j : '').trim() || companyName;
    const organizationId = sanitizeOrganizationId(orgIdInput);
    if (!organizationId)
        throw httpsError('invalid-argument', 'organizationId requerido.');
    const orgName = String((_k = data === null || data === void 0 ? void 0 : data.organizationName) !== null && _k !== void 0 ? _k : '').trim() || companyName || organizationId;
    const orgLegalName = maybeString(data === null || data === void 0 ? void 0 : data.organizationLegalName);
    const orgCountry = (_l = maybeString(data === null || data === void 0 ? void 0 : data.organizationCountry)) !== null && _l !== void 0 ? _l : 'ES';
    const billingEmail = (_m = maybeString(data === null || data === void 0 ? void 0 : data.organizationBillingEmail)) !== null && _m !== void 0 ? _m : email;
    const orgRef = db.collection('organizations').doc(organizationId);
    ...
    const targetUid = (_o = authUser === null || authUser === void 0 ? void 0 : authUser.uid) !== null && _o !== void 0 ? _o : '';
    ...
    await db.runTransaction(async (tx) => {
        ...
        tx.create(orgRef, {
            ...
            entitlement: buildEntitlementPayload({
                ...
                status: 'trialing',
                now,
                usage: Object.assign(Object.assign({}, DEFAULT_ENTITLEMENT_USAGE), { usersCount: 1 }),
            }),
            settings: {
        ...
        tx.set(orgRef.collection('settings').doc('main'), Object.assign(Object.assign({ organizationId }, DEFAULT_ORG_SETTINGS_MAIN), { createdAt: now, updatedAt: now, source: 'rootCreateAccountFromBetaRequest_v1' }), { merge: true });
...
exports.rootSetOrganizationPlan = functions.https.onCall(async (data, context) => {
    ...
    await db.runTransaction(async (tx) => {
        ...
        const limits = resolveEffectiveLimitsForPlan(resolvedPlanId, hasPlanChanged(currentEntitlement === null || currentEntitlement === void 0 ? void 0 : currentEntitlement.planId, resolvedPlanId) ? null : currentEntitlement === null || currentEntitlement === void 0 ? void 0 : currentEntitlement.limits);
...
exports.createTicketUploadSession = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
        const ticketId = String((_d = data === null || data === void 0 ? void 0 : data.ticketId) !== null && _d !== void 0 ? _d : '').trim();
        const maxFiles = Math.min(Number((_e = data === null || data === void 0 ? void 0 : data.maxFiles) !== null && _e !== void 0 ? _e : 10) || 10, 10);
        if (!orgId || !ticketId) {
        ...
        return await db.runTransaction(async (tx) => {
            ...
            const maxAttachmentMB = Number((_a = effectiveLimits.maxAttachmentMB) !== null && _a !== void 0 ? _a : 0) || 0;
            const monthlyMB = Number((_b = effectiveLimits.attachmentsMonthlyMB) !== null && _b !== void 0 ? _b : 0) || 0;
            const perTicket = Number((_c = effectiveLimits.maxAttachmentsPerTicket) !== null && _c !== void 0 ? _c : 0) || 0;
        ...
        if (error instanceof functions.https.HttpsError || ((_f = error === null || error === void 0 ? void 0 : error.constructor) === null || _f === void 0 ? void 0 : _f.name) === 'HttpsError') {
            throw error;
        }
...
exports.registerTicketAttachment = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
        const ticketId = String((_d = data === null || data === void 0 ? void 0 : data.ticketId) !== null && _d !== void 0 ? _d : '').trim();
        const sizeBytes = Number((_e = data === null || data === void 0 ? void 0 : data.sizeBytes) !== null && _e !== void 0 ? _e : 0) || 0;
        const fileName = String((_f = data === null || data === void 0 ? void 0 : data.fileName) !== null && _f !== void 0 ? _f : '').trim();
        const contentType = String((_g = data === null || data === void 0 ? void 0 : data.contentType) !== null && _g !== void 0 ? _g : '').trim();
        ...
        return await db.runTransaction(async (tx) => {
            ...
            const monthlyMB = Number((_b = effectiveLimits.attachmentsMonthlyMB) !== null && _b !== void 0 ? _b : 0) || 0;
            const perTicket = Number((_c = effectiveLimits.maxAttachmentsPerTicket) !== null && _c !== void 0 ? _c : 0) || 0;
            const usedThisMonth = Number((_e = (_d = entitlement.usage) === null || _d === void 0 ? void 0 : _d.attachmentsThisMonthMB) !== null && _e !== void 0 ? _e : 0) || 0;
            if (monthlyMB <= 0 || maxAttachmentMB <= 0 || perTicket <= 0) {
                throw new functions.https.HttpsError('failed-precondition', 'Los adjuntos no están disponibles en tu plan.', 'attachments_not_allowed');
            }
            ...
            const allowedFiles = (sessionSnap.get('allowedFiles') || {});
            if (allowedFiles[fileName]) {
                throw new functions.https.HttpsError('already-exists', 'El archivo ya fue registrado.');
            }
            const maxFiles = Number((_f = sessionSnap.get('maxFiles')) !== null && _f !== void 0 ? _f : 0) || 0;
            ...
            if (ticketSnap.exists) {
                const currentUrls = Array.isArray(ticketSnap.get('photoUrls')) ? ticketSnap.get('photoUrls') : [];
            ...
            tx.update(sessionRef, new admin.firestore.FieldPath('allowedFiles', fileName), {
                sizeBytes,
                contentType,
        ...
        if (error instanceof functions.https.HttpsError || ((_h = error === null || error === void 0 ? void 0 : error.constructor) === null || _h === void 0 ? void 0 : _h.name) === 'HttpsError') {
            throw error;
        }
...
exports.createTicket = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
        const payload = ((_d = data === null || data === void 0 ? void 0 : data.payload) !== null && _d !== void 0 ? _d : data);
        const providedTicketId = String((_f = (_e = payload === null || payload === void 0 ? void 0 : payload.ticketId) !== null && _e !== void 0 ? _e : data === null || data === void 0 ? void 0 : data.ticketId) !== null && _f !== void 0 ? _f : '').trim() || undefined;
        if (!orgId) {
        ...
        return await db.runTransaction(async (tx) => {
            ...
            const locationId = String((_b = (_a = payload === null || payload === void 0 ? void 0 : payload.locationId) !== null && _a !== void 0 ? _a : payload === null || payload === void 0 ? void 0 : payload.siteId) !== null && _b !== void 0 ? _b : '').trim();
            const originDepartmentId = String((_c = payload === null || payload === void 0 ? void 0 : payload.originDepartmentId) !== null && _c !== void 0 ? _c : '').trim() || undefined;
            const targetDepartmentId = String((_d = payload === null || payload === void 0 ? void 0 : payload.targetDepartmentId) !== null && _d !== void 0 ? _d : '').trim() || undefined;
            const departmentId = String((_e = payload === null || payload === void 0 ? void 0 : payload.departmentId) !== null && _e !== void 0 ? _e : '').trim() || undefined;
            const effectiveDepartmentId = (_f = targetDepartmentId !== null && targetDepartmentId !== void 0 ? targetDepartmentId : originDepartmentId) !== null && _f !== void 0 ? _f : departmentId;
            if (!locationId) {
            ...
            const status = (_g = payload === null || payload === void 0 ? void 0 : payload.status) !== null && _g !== void 0 ? _g : 'new';
            if (isOpenStatus(status)) {
                const current = Number((_h = usage === null || usage === void 0 ? void 0 : usage.openTicketsCount) !== null && _h !== void 0 ? _h : 0) || 0;
                const max = Number((_j = limits === null || limits === void 0 ? void 0 : limits.maxOpenTickets) !== null && _j !== void 0 ? _j : 0) || 0;
            ...
            const displayId = (payload === null || payload === void 0 ? void 0 : payload.displayId) || `INC-${nowYear}-${String(Date.now()).slice(-4)}`;
            const createdByName = String((_p = (_m = (_k = payload === null || payload === void 0 ? void 0 : payload.createdByName) !== null && _k !== void 0 ? _k : (_l = resolved.userData) === null || _l === void 0 ? void 0 : _l.displayName) !== null && _m !== void 0 ? _m : (_o = resolved.userData) === null || _o === void 0 ? void 0 : _o.email) !== null && _p !== void 0 ? _p : uid);
            const docData = {
                organizationId: orgId,
                locationId,
                originDepartmentId: originDepartmentId !== null && originDepartmentId !== void 0 ? originDepartmentId : null,
                targetDepartmentId: targetDepartmentId !== null && targetDepartmentId !== void 0 ? targetDepartmentId : null,
                departmentId: departmentId !== null && departmentId !== void 0 ? departmentId : null,
                title: String((_q = payload === null || payload === void 0 ? void 0 : payload.title) !== null && _q !== void 0 ? _q : '').trim(),
                description: String((_r = payload === null || payload === void 0 ? void 0 : payload.description) !== null && _r !== void 0 ? _r : '').trim(),
                type: (_s = payload === null || payload === void 0 ? void 0 : payload.type) !== null && _s !== void 0 ? _s : 'correctivo',
                status,
                priority: (_t = payload === null || payload === void 0 ? void 0 : payload.priority) !== null && _t !== void 0 ? _t : 'Media',
                assetId: (_u = payload === null || payload === void 0 ? void 0 : payload.assetId) !== null && _u !== void 0 ? _u : null,
                createdBy: uid,
                createdByName,
                assignedRole: (_v = payload === null || payload === void 0 ? void 0 : payload.assignedRole) !== null && _v !== void 0 ? _v : 'mantenimiento',
                assignedTo: (_w = payload === null || payload === void 0 ? void 0 : payload.assignedTo) !== null && _w !== void 0 ? _w : null,
                createdAt: admin.firestore.FieldValue.serverTimestamp(),
                updatedAt: admin.firestore.FieldValue.serverTimestamp(),
                displayId,
                photoUrls: Array.isArray(payload === null || payload === void 0 ? void 0 : payload.photoUrls) ? payload.photoUrls : [],
                hasAttachments: Array.isArray(payload === null || payload === void 0 ? void 0 : payload.photoUrls) && payload.photoUrls.length > 0,
            };
        ...
        if (error instanceof functions.https.HttpsError || ((_g = error === null || error === void 0 ? void 0 : error.constructor) === null || _g === void 0 ? void 0 : _g.name) === 'HttpsError') {
            throw error;
        }
...
exports.updateTicketStatus = functions.https.onCall(async (data, context) => {
    ...
    const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
    const ticketId = String((_d = data === null || data === void 0 ? void 0 : data.ticketId) !== null && _d !== void 0 ? _d : '').trim();
    const newStatus = data === null || data === void 0 ? void 0 : data.newStatus;
    const patch = ((_e = data === null || data === void 0 ? void 0 : data.patch) !== null && _e !== void 0 ? _e : {});
    const reportAppend = data === null || data === void 0 ? void 0 : data.reportAppend;
    if (!orgId || !ticketId) {
        throw new functions.https.HttpsError('invalid-argument', 'Faltan orgId o ticketId.');
    }
    return await db.runTransaction(async (tx) => {
        ...
        const effectiveNewStatus = (_a = newStatus !== null && newStatus !== void 0 ? newStatus : patch === null || patch === void 0 ? void 0 : patch.status) !== null && _a !== void 0 ? _a : oldStatus;
        const wasOpen = isOpenStatus(oldStatus);
        const willBeOpen = isOpenStatus(effectiveNewStatus);
        if (!wasOpen && willBeOpen) {
            const current = Number((_b = usage === null || usage === void 0 ? void 0 : usage.openTicketsCount) !== null && _b !== void 0 ? _b : 0) || 0;
            const max = Number((_c = limits === null || limits === void 0 ? void 0 : limits.maxOpenTickets) !== null && _c !== void 0 ? _c : 0) || 0;
            if (max > 0 && current >= max) {
                throw new functions.https.HttpsError('failed-precondition', 'Has alcanzado el límite de incidencias abiertas de tu plan.', 'max_open_tickets_reached');
            }
        }
        // Scope enforcement for scoped roles when changing scope-related fields.
        const nextLocationId = String(((_f = (_e = (_d = patch === null || patch === void 0 ? void 0 : patch.locationId) !== null && _d !== void 0 ? _d : patch === null || patch === void 0 ? void 0 : patch.siteId) !== null && _e !== void 0 ? _e : ticketSnap.get('locationId')) !== null && _f !== void 0 ? _f : '')).trim();
        const nextOriginDept = String(((_h = (_g = patch === null || patch === void 0 ? void 0 : patch.originDepartmentId) !== null && _g !== void 0 ? _g : ticketSnap.get('originDepartmentId')) !== null && _h !== void 0 ? _h : '')).trim();
        const nextTargetDept = String(((_k = (_j = patch === null || patch === void 0 ? void 0 : patch.targetDepartmentId) !== null && _j !== void 0 ? _j : ticketSnap.get('targetDepartmentId')) !== null && _k !== void 0 ? _k : '')).trim();
        const nextLegacyDept = String(((_m = (_l = patch === null || patch === void 0 ? void 0 : patch.departmentId) !== null && _l !== void 0 ? _l : ticketSnap.get('departmentId')) !== null && _m !== void 0 ? _m : '')).trim();
        ...
        const updateData = Object.assign({ updatedAt: admin.firestore.FieldValue.serverTimestamp(), organizationId: orgId }, patch);
        ...
        if ((reportAppend === null || reportAppend === void 0 ? void 0 : reportAppend.description) && String(reportAppend.description).trim().length > 0) {
            const entry = {
...
exports.createTask = functions.https.onCall(async (data, context) => {
    ...
    const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
    const payload = ((_d = data === null || data === void 0 ? void 0 : data.payload) !== null && _d !== void 0 ? _d : data);
    const providedTaskId = String((_f = (_e = payload === null || payload === void 0 ? void 0 : payload.taskId) !== null && _e !== void 0 ? _e : data === null || data === void 0 ? void 0 : data.taskId) !== null && _f !== void 0 ? _f : '').trim() || undefined;
    if (!orgId) {
        throw new functions.https.HttpsError('invalid-argument', 'Falta orgId.');
    }
    return await db.runTransaction(async (tx) => {
        ...
        const limits = entitlement.limits;
        const usage = entitlement.usage;
        const status = (_a = payload === null || payload === void 0 ? void 0 : payload.status) !== null && _a !== void 0 ? _a : 'open';
        if (isOpenStatus(status)) {
            const current = Number((_b = usage === null || usage === void 0 ? void 0 : usage.openTasksCount) !== null && _b !== void 0 ? _b : 0) || 0;
            const max = Number((_c = limits === null || limits === void 0 ? void 0 : limits.maxOpenTasks) !== null && _c !== void 0 ? _c : 0) || 0;
            if (max > 0 && current >= max) {
        ...
        const locationId = String((_d = payload === null || payload === void 0 ? void 0 : payload.locationId) !== null && _d !== void 0 ? _d : '').trim();
        const originDepartmentId = String((_e = payload === null || payload === void 0 ? void 0 : payload.originDepartmentId) !== null && _e !== void 0 ? _e : '').trim() || undefined;
        const targetDepartmentId = String((_f = payload === null || payload === void 0 ? void 0 : payload.targetDepartmentId) !== null && _f !== void 0 ? _f : '').trim() || undefined;
        const departmentId = String((_g = payload === null || payload === void 0 ? void 0 : payload.departmentId) !== null && _g !== void 0 ? _g : '').trim() || undefined;
        const effectiveDepartmentId = (_h = targetDepartmentId !== null && targetDepartmentId !== void 0 ? targetDepartmentId : originDepartmentId) !== null && _h !== void 0 ? _h : departmentId;
        if (locationId) {
            requireScopedAccessToSite(resolved.role, resolved.scope, locationId);
        }
        if (effectiveDepartmentId) {
        ...
        const now = admin.firestore.FieldValue.serverTimestamp();
        const docData = Object.assign(Object.assign({}, payload), { organizationId: orgId, createdBy: uid, status, createdAt: now, updatedAt: now });
...
exports.updateTaskStatus = functions.https.onCall(async (data, context) => {
    ...
    const orgId = String((_c = (_b = data === null || data === void 0 ? void 0 : data.orgId) !== null && _b !== void 0 ? _b : data === null || data === void 0 ? void 0 : data.organizationId) !== null && _c !== void 0 ? _c : '').trim();
    const taskId = String((_d = data === null || data === void 0 ? void 0 : data.taskId) !== null && _d !== void 0 ? _d : '').trim();
    const newStatus = data === null || data === void 0 ? void 0 : data.newStatus;
    const patch = ((_e = data === null || data === void 0 ? void 0 : data.patch) !== null && _e !== void 0 ? _e : {});
    const reportAppend = data === null || data === void 0 ? void 0 : data.reportAppend;
    if (!orgId || !taskId) {
    ...
    return await db.runTransaction(async (tx) => {
        ...
        const nextLocationId = String(((_e = (_d = patch === null || patch === void 0 ? void 0 : patch.locationId) !== null && _d !== void 0 ? _d : taskSnap.get('locationId')) !== null && _e !== void 0 ? _e : '')).trim();
        const nextOriginDept = String(((_g = (_f = patch === null || patch === void 0 ? void 0 : patch.originDepartmentId) !== null && _f !== void 0 ? _f : taskSnap.get('originDepartmentId')) !== null && _g !== void 0 ? _g : '')).trim();
        const nextTargetDept = String(((_j = (_h = patch === null || patch === void 0 ? void 0 : patch.targetDepartmentId) !== null && _h !== void 0 ? _h : taskSnap.get('targetDepartmentId')) !== null && _j !== void 0 ? _j : '')).trim();
        const nextLegacyDept = String(((_l = (_k = patch === null || patch === void 0 ? void 0 : patch.departmentId) !== null && _k !== void 0 ? _k : taskSnap.get('departmentId')) !== null && _l !== void 0 ? _l : '')).trim();
        const nextDept = nextTargetDept || nextOriginDept || nextLegacyDept;
        if (nextLocationId) {
            requireScopedAccessToSite(resolved.role, resolved.scope, nextLocationId);
        }
...
exports.updatePreventiveTemplate = functions.https.onCall(async (data, context) => {
    ...
    await db.runTransaction(async (tx) => {
        ...
        else if (typeof data.pausedReason === 'string' && String(data.pausedReason).trim()) {
            tx.update(templateRef, {
                pausedReason: String(data.pausedReason).trim(),
            });
        }
    });
    await auditLog({
...
exports.deletePreventiveTemplate = functions.https.onCall(async (data, context) => {
    var _a, _b, _c;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    const orgId = resolveOrgIdFromData(data);
    ...
    await db.runTransaction(async (tx) => {
        ...
        if (!openWosSnap.empty) {
            throw httpsError('failed-precondition', 'No se puede eliminar: existen OTs preventivas abiertas asociadas a esta plantilla.');
        }
...
exports.generatePreventiveNow = functions.https.onCall(async (data, context) => {
    var _a, _b, _c;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    const orgId = resolveOrgIdFromData(data);
    ...
    await db.runTransaction(async (tx) => {
        ...
        if (!(schedule === null || schedule === void 0 ? void 0 : schedule.type))
            throw httpsError('failed-precondition', 'La plantilla no tiene programación válida.');
        ...
        const ticketPayload = {
            ...
            type: 'preventivo',
            status: 'new',
            priority: (_b = template.priority) !== null && _b !== void 0 ? _b : 'Media',
            siteId: template.siteId,
            departmentId: template.departmentId,
            assetId: (_c = template.assetId) !== null && _c !== void 0 ? _c : null,
            title: template.name,
            description: (_d = template.description) !== null && _d !== void 0 ? _d : '',
            createdBy: actorUid,
            assignedRole: 'mantenimiento',
            assignedTo: null,
            createdAt: nowServer,
            ...
            preventive: {
                ...
                checklist: (_e = template.checklist) !== null && _e !== void 0 ? _e : [],
            },
...
function normalizeChecklistItems(raw) {
    ...
    for (const it of arr) {
        ...
        if (it && typeof it === 'object') {
            const anyIt = it;
            const label = String((_c = (_b = (_a = anyIt.label) !== null && _a !== void 0 ? _a : anyIt.text) !== null && _b !== void 0 ? _b : anyIt.name) !== null && _c !== void 0 ? _c : '').trim();
            if (!label)
                continue;
            const required = Boolean((_d = anyIt.required) !== null && _d !== void 0 ? _d : true);
            items.push({ label, required, order: Number((_e = anyIt.order) !== null && _e !== void 0 ? _e : order) });
            continue;
        }
    }
    return items;
}
exports.workOrders_generateNow = functions.https.onCall(async (data, context) => {
    var _a, _b, _c;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    const orgId = resolveOrgIdFromData(data);
    ...
    await db.runTransaction(async (tx) => {
        ...
        const frequencyDays = resolveFrequencyDays(schedule);
        ensureEntitlementAllowsCreate({ kind: 'preventives', entitlement, features });
        const checklistItems = normalizeChecklistItems(template.checklist);
...
exports.workOrders_start = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    const orgId = resolveOrgIdFromData(data);
    ...
    if (!woSnap.exists)
        throw httpsError('not-found', 'OT no encontrada.');
    if (String((_d = woSnap.get('organizationId')) !== null && _d !== void 0 ? _d : '') !== orgId) {
        throw httpsError('permission-denied', 'OT fuera de la organización.');
    }
    const wo = woSnap.data();
    const createdBy = String((_e = wo === null || wo === void 0 ? void 0 : wo.createdBy) !== null && _e !== void 0 ? _e : '');
    const assignedTo = String((_f = wo === null || wo === void 0 ? void 0 : wo.assignedTo) !== null && _f !== void 0 ? _f : '');
    ...
    if ((wo === null || wo === void 0 ? void 0 : wo.isOpen) !== true) {
        throw httpsError('failed-precondition', 'La OT está cerrada.');
    }
    const currentStatus = String((_g = wo === null || wo === void 0 ? void 0 : wo.status) !== null && _g !== void 0 ? _g : 'open');
...
exports.workOrders_close = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    const orgId = resolveOrgIdFromData(data);
    ...
    const checklistRequired = Boolean((wo === null || wo === void 0 ? void 0 : wo.checklistRequired) === true);
...
exports.workOrders_addReport = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    const actorUid = requireAuth(context);
    const actorEmail = ((_c = (_b = (_a = context.auth) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : null);
    try {
        const orgId = resolveOrgIdFromData(data);
        const woId = requireStringField(data === null || data === void 0 ? void 0 : data.woId, 'woId');
        const descriptionRaw = String((_j = (_g = (_e = (_d = data === null || data === void 0 ? void 0 : data.description) !== null && _d !== void 0 ? _d : data === null || data === void 0 ? void 0 : data.text) !== null && _e !== void 0 ? _e : (_f = data === null || data === void 0 ? void 0 : data.reportAppend) === null || _f === void 0 ? void 0 : _f.description) !== null && _g !== void 0 ? _g : (_h = data === null || data === void 0 ? void 0 : data.payload) === null || _h === void 0 ? void 0 : _h.description) !== null && _j !== void 0 ? _j : '').trim();
        if (!descriptionRaw) {
        ...
        if (!woSnap.exists)
            throw httpsError('not-found', 'OT no encontrada.');
        if (String((_k = woSnap.get('organizationId')) !== null && _k !== void 0 ? _k : '') !== orgId) {
            throw httpsError('permission-denied', 'OT fuera de la organización.');
        }
        const wo = woSnap.data();
        const createdBy = String((_l = wo === null || wo === void 0 ? void 0 : wo.createdBy) !== null && _l !== void 0 ? _l : '');
        const assignedTo = String((_m = wo === null || wo === void 0 ? void 0 : wo.assignedTo) !== null && _m !== void 0 ? _m : '');
        const isAdminLike = ADMIN_LIKE_ROLES.has(role);
        const isActorRelated = actorUid === createdBy || (assignedTo && actorUid === assignedTo);
        if (!isAdminLike && !isActorRelated) {
        ...
        if (error instanceof functions.https.HttpsError || ((_o = error === null || error === void 0 ? void 0 : error.constructor) === null || _o === void 0 ? void 0 : _o.name) === 'HttpsError') {
            throw error;
        }
