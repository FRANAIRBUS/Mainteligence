...
const buildSignupConfirmationContent = ({ orgName, confirmationLink }: SignupConfirmationInput) => {
...
export const sendSignupConfirmationEmail = async (input: SignupConfirmationInput) => {
