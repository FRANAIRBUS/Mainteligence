...
import type { FirestorePermissionError, StoragePermissionError } from '@/lib/firebase/errors';

// This component listens for permission errors and throws them to be caught by Next.js's dev overlay.
export function FirebaseErrorListener() {
  useEffect(() => {
    const handleError = (error: FirestorePermissionError | StoragePermissionError) => {
