...
function LegacyThermostatPanel({
  ...
  const inoutDisplayFontSize = useMemo(() => {
    ...
    return `${Math.min(36, Math.max(20, scaled)).toFixed(1)}px`;
  }, [displayWidth]);
      ...
      >
        ...
        {activeSkin === 'inout' ? (
          <>
            ...
            <div
              className="absolute right-[65.0%] top-[38.0%] flex h-[15.0%] w-[20.0%] items-center justify-end pr-[6%] text-right text-red-600"
            ...
            <div
              className="absolute right-[65.0%] top-[62.0%] flex h-[15.0%] w-[20.0%] items-center justify-end pr-[6%] text-right text-red-600"
              style={inoutDisplayStyle}
            >
              <span className="inline-flex w-full items-end justify-end gap-[0.12em]">
